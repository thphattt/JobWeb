...
> **Đăng ký domain:** làm theo file riêng **`DOMAIN.md`** (Vietnix, đứng tên khách).
...
**→ Làm theo quy trình chi tiết trong `DOMAIN.md`**: đăng ký `.com` tại Vietnix, tài khoản + chủ thể đứng tên khách, kèm thủ tục **thông báo tên miền quốc tế** bắt buộc tại thongbaotenmien.vn. Chi phí: ~235–300k năm đầu, gia hạn ~320k/năm (chưa VAT).
...
3. **Email form liên hệ (Resend):** dashboard Resend → **Domains** → add `tanchauthanh.com` → thêm bản ghi SPF/DKIM vào DNS Vietnix (portal.vietnix.vn) → chờ verify → sửa `CONTACT_FROM_EMAIL="Tân Châu Thành <lienhe@tanchauthanh.com>"` trong `.env` → `pm2 restart jobweb`.
...
| Khoản | Chi phí |
|---|---|
| Domain `.com` tại Vietnix (theo `DOMAIN.md`) | ~235–300k năm đầu, gia hạn ~320k/năm |
...
| **Tổng (Cheap 1 + .com)** | **~2,2–2,4 triệu đ/năm** (chưa VAT) |
